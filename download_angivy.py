#!/usr/bin/env python3
"""
Télécharge l'image de l'Angivy (aubergine malgache) depuis Wikipedia
"""
...
def main():
    print("=" * 70)
    print("🍆 Téléchargement de l'image Angivy (Aubergine malgache)")
    print("=" * 70)
    print()
    
    # Termes de recherche pour l'aubergine malgache/africaine
    search_terms = [
        "Solanum aethiopicum",  # Aubergine africaine (bitter eggplant)
    ...
    for term in search_terms:
        ...
        if url:
            ...
            if download_image(url, filename):
                print()
                print("✅ Image Angivy téléchargée avec succès!")
                return
    ...
    print()
    print("❌ Aucune image trouvée sur Wikipedia")
    print("💡 Essayez manuellement sur:")
    print("   - https://commons.wikimedia.org/wiki/Solanum_aethiopicum")
    print("   - https://commons.wikimedia.org/wiki/Solanum_macrocarpon")
